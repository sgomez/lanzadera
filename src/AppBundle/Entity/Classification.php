 ...
 * @ORM\Entity(repositoryClass="AppBundle\Doctrine\ORM\ClassificationRepository")
 */
class Classification
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Certificate", mappedBy="classification", cascade={"persist"})
     */
     ...
     * @return Classification
     */
    public function addCertificate(Certificate $certificates)
    {
     ...
     * @param Certificate $certificates
     */
    public function removeCertificate(Certificate $certificates)
    {
